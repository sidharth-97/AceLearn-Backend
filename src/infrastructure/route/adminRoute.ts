...
adminRoute.get("/get-premium-price", (req, res, next) => controller.showPremiumPrice(req, res, next))
adminRoute.post("/change-premium",(req,res,next)=>controller.setPremium(req,res,next))
